...
export default function Navbar() {
  ...
  // Toggle between "Sign in" and "Sign up" every 3 seconds (desktop only)
  useEffect(() => {
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-3 border-t border-border">
              <div className="flex flex-col gap-2">
                ...
                {session && (
                  <>
                    <Link href="/rated-movies" className="px-3 py-2 rounded-lg hover:bg-surface transition">Top Rated</Link>
